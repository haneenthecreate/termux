...
def menu():
                   ...
                   os.system("pkg install -y jp2a ") 
                   os.system("pkg install -y jp2a ")
                   os.system("clear")                  
                   os.system("jp2a https://1.bp.blogspot.com/-mDoiBeBDoas/YROrwwog82I/AAAAAAAAAI4/-nml79fL_RUhRfnC7vGiqTTYeBJfRATpgCLcBGAsYHQ/s150/logo.jpg --color")
                   print(""" 
                          Created By Haneen the CREATE™
Website     : www.haneenthecreate.ml
blog        : haneenthecreate.blogspot.com
Instagram   : @haneen_the_create


              *script only Works in Android Device*

          +-------------------------------------------+
            Lets install Hacking Machines In termux  |  
          +-------------------------------------------+
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
1.  Install Nmap 
2.  Install Hydra
...
while loop:
    menu()
    what = input("SELECT YOUR TOOL TO INSTALL:-")
    if what == "00":
        print("================================")
        ...
        if hm == "y":
            print("========================================================")
            print("[+] Please put down your android ...")
    ...
    if what == "1":
        ...
        print("It's Haneen | thanks for Using My tool  | Join in My Communty by searching Haneen the Create in google .")
        break
